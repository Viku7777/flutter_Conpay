...
class ForgotEnteNumber extends StatefulWidget {
  const ForgotEnteNumber({super.key});

  @override
  State<ForgotEnteNumber> createState() => _ForgotEnteNumberState();
}

class _ForgotEnteNumberState extends State<ForgotEnteNumber> {
